...
- ❤️ + ✅ 동시 가능 (둘은 양립)
- 🌱 누르면 ❤️는 자동 해제 (프론트엔드에서 처리: 🌱 INSERT 전에 star DELETE)
...
- 카드 반응 카운트 영역 탭 시 열림
- 3개 큰 버튼 (수직):
  - ❤️ 유용했어요 / "도움이 되는 인사이트네요" / 현재 N명
  - ✅ 나도 검증함 / "현장에서 실제로 적용해봤어요" / 현재 N명
  - 🌱 같이 키워봐요 / "아직 검증 전이지만 좋은 아이디어예요" / 현재 N명
